...
const Trafficlight = () => {
	...
	let toggle = () => {
		trafficColor === "red" ? (setTrafficColor("yellow")) : 
		trafficColor === "yellow" ? (setTrafficColor("green")) :
		trafficColor === "green" ? (setTrafficColor("red")) : null;
	}
	...
	return (
		<div className="container d-flex align-items-center flex-column">
			...
			<br />
			<button type="button" onClick={() => setInterval(toggle(), 3000)} className="btn btn-dark">Auto-toggle</button>
